 ...
 */
gulp.task('ts:lint', gulp.series(function () {
 ...
 */
gulp.task('statics:copy', gulp.series('clean', function () {
 ...
 * Build manifest
 */
gulp.task('generate-manifest', gulp.series(function() {
 ...
 * Run tests.
 */
gulp.task('test', gulp.series('ts', 'statics:copy', function() {
    return gulp
